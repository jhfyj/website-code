...
brandingLoader.load("/actualmodel/branding.glb", (gltf) => {
...
aboutMeLoader.load("/actualmodel/aboutme.glb", (gltf) => {
...
graphicDesignLoader.load("/actualmodel/graphicdesign.glb", (gltf) => {
...
immersiveexperieinceLoader.load("/actualmodel/immersive.glb", (gltf) => {
...
motiongraphicLoader.load("/actualmodel/motiongraphic.glb", (gltf) => {
